...
**Демо-кабинет:** `demo@example.com` / `pulse-demo-2026` — внутри три настоящих
рилса с накопленной историей замеров: у самого старого она за неделю, и рост
просмотров на графике читается в разы, а не в процентах. Плюс дашборд с
графиками и лог синхронизаций. Можно добавлять свои ссылки, ничего не
сломается: расход Apify ограничен тремя независимыми предохранителями
(см. ниже).
...
На момент сдачи за всю разработку израсходовано **полтора десятка результатов
из ≈1850** — меньше процента месячного лимита на девять срезов работы.
