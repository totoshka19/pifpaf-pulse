...
- [ ] **Шаг 1: Написать падающие тесты на склонение**
...
- [ ] **Шаг 5: Написать падающие тесты на числа**
...
- [ ] **Шаг 7: Реализовать форматирование чисел**
...
- [ ] **Шаг 4: Реализовать форматирование дат**
...
- [ ] **Шаг 3: Реализовать приведение типов и прирост**
...
- [ ] **Шаг 5: Разрешить новую сортировку в API**
...
- [ ] **Шаг 1: Написать падающие тесты на фильтры**
...
- [ ] **Шаг 4: Написать падающие тесты на опрос и разбор**
...
- [ ] **Шаг 6: Реализовать опрос и разбор**
...
- [ ] **Шаг 6: Проверить эндпоинт руками**
...
- [ ] **Шаг 1: Дописать токены оформления**
...
- [ ] **Шаг 3: Редирект с `/app` и страница ленты**
...
- [ ] **Шаг 4: Скелетоны и пустое состояние**
...
- [ ] **Шаг 6: Остров ленты в минимальном виде**
...
- [ ] **Шаг 1: Разрешить квадратную обложку**
...
- [ ] **Шаг 4: Подключить панель и переключатель к острову**
...
- [ ] **Шаг 2: Опрос pending-рилсов в острове**
...
- [ ] **Шаг 3: Подключить форму и подсветку дубликата**
...
- [ ] **Шаг 3: Подключить мутации в острове**
...
- [ ] **Шаг 1: Разделить два пустых состояния**
...
- [ ] **Шаг 5: Проверить состояния по очереди**
...
- [ ] **Шаг 4: Проверить прод после деплоя**
...
- [ ] `npm test` зелёный, тестов больше 133 минимум на 60
- [ ] `npm run test:db` зелёный, тестов больше 34 минимум на 9
- [ ] `npm run build` и `npm run lint` без ошибок
- [ ] `npm run e2e:feed` — все проверки прошли
- [ ] `/app` ведёт на ленту; сетка и таблица переключаются мгновенно
- [ ] Вставка ссылки даёт карточку сразу, данные подтягиваются без перезагрузки
- [ ] Повторная вставка не создаёт дубль, а подсвечивает существующую карточку
- [ ] Все пять состояний карточки выглядят осмысленно
- [ ] «—» вместо нуля там, где данных нет; ноль там, где он настоящий
- [ ] Даты московские, числа в русском формате
- [ ] На 375 px страница не прокручивается вбок
