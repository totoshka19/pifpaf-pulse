...
- [ ] **Открыть прод с телефона на мобильном интернете без VPN.**
      Задеплоено: https://iridescent-biscuit-442fa5.netlify.app (Netlify, не Vercel —
      см. `PLAN.md` §13). Сам деплой сделан и проверен снаружи, но доступность
      из России может подтвердить только человек с российского мобильного.
